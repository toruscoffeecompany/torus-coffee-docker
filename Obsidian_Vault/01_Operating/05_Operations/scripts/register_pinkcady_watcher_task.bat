@echo off
REM Admin script: register Pinkcady Comms Watcher as a Windows Scheduled Task
...
REM --- Config ---
set TASK_NAME=Pinkcady_Comms_Watcher
...
set SCRIPT="D:\Work\Torus Coffee Company LLC\10_Skills_Library\05_Operations\Crew\pinkcady_comms_watcher.py"
...
REM --- Register task (every 10 minutes, run whether user is logged on or not) ---
...
echo [INFO] View it in Task Scheduler under 'Pinkcady_Comms_Watcher'
