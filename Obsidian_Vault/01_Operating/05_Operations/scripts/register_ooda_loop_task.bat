@echo off
REM Admin script: register OODA Self-Prompting Loop as a Windows Scheduled Task
...
REM --- Config ---
set TASK_NAME=Miss_Pink_OODA_Loop
...
set SCRIPT="D:\Work\Torus Coffee Company LLC\10_Skills_Library\05_Operations\Crew\ooda_self_prompt_loop.py"
...
echo [INFO] View it in Task Scheduler under 'Miss_Pink_OODA_Loop'
