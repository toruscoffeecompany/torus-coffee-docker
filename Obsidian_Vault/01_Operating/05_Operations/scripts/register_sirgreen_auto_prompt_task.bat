@echo off
REM Admin script: register Sir Green Auto-Prompt Generator as a Windows Scheduled Task
...
REM --- Config ---
set TASK_NAME=Sir_Green_Auto_Prompt
...
set SCRIPT="D:\Work\Torus Coffee Company LLC\10_Skills_Library\05_Operations\scripts\sirgreen_auto_prompt.py"
...
echo [INFO] View it in Task Scheduler under 'Sir_Green_Auto_Prompt'
