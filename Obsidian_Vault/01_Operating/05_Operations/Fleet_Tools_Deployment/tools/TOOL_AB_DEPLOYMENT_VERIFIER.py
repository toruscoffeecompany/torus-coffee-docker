...
class DeploymentVerifier:
    def __init__(self, pinkcady_ip="127.0.0.1", base_port=9000):
        self.pinkcady_ip = pinkcady_ip
        self.base_port = base_port
        self.verify_log = Path(r"D:\Work\Torus Coffee Company LLC\10_Skills_Library\05_Operations\ops_notes\deployment_verification.json")
